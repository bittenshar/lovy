...
const { uploadBusinessLogo, uploadToCloudinary } = require('../../shared/middlewares/upload.middleware');
...
router.patch('/:businessId', uploadBusinessLogo, uploadToCloudinary('business-logos'), requirePermissions('edit_business'), controller.updateBusiness);
